...
// IMPORTANTE: Importar la pantalla de detalle
      ...
      body: provider.isLoading
          ...
          : ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  elevation: 2,
                  clipBehavior: Clip.antiAlias, // Necesario para el InkWell
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      // 1. Vamos al detalle y esperamos a que el usuario vuelva
                      ...
                      // 2. Al volver, recargamos para actualizar "Gastado" y "Saldo"
                      if (mounted) {
                        context
